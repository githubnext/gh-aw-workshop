...
- [Side Quest: Jailbreaking the Agent Brief](side-quest-10-02-jailbreak-brief.md) — explains how adversarial instructions in repository content (issues, PR bodies, commit messages) can attempt to override the workflow brief, and how a specific task brief, minimal `permissions:`, and `safe-outputs` limit the attack; branches from [Step 10](10-choose-your-scenario.md).
