...
- [Diagnosing Common Agent Output Patterns](side-quest-09-01-debug-output.md) — expanded troubleshooting guide for the six most common log patterns; branches from [Step 9](08b-interpret-your-run.md).
...
- [Pattern: `tools_denials_exceeded`](side-quest-09-01g-pattern-tool-denials-exceeded.md) — how to distinguish too many denied tool calls from a timeout and correct the tool policy or prompt; branches from [Diagnosing Common Agent Output Patterns](side-quest-09-01-debug-output.md).
- [Debugging Checklist](side-quest-09-01f-debugging-checklist.md) — a repeatable eight-step triage flow to apply whenever a run produces unexpected output; branches from [Diagnosing Common Agent Output Patterns](side-quest-09-01-debug-output.md).
