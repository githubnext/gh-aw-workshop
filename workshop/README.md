...
- [Chaining Conditions — Weekend Skip](side-quest-15-02-chaining-conditions.md) — hands-on exercise for extending a commit-count condition to also skip on weekends by chaining `&&` conditions in the top-level `if:`; branches from [Step 15](15-conditional-logic.md).
