...
- [Side Quest: Prompt Iteration Patterns](side-quest-12-01-iteration-patterns.md) — four concrete patterns for diagnosing weak agent output and applying targeted fixes to your task brief; branches from [Step 12](12-test-and-iterate.md).
