...
- [Side Quest: Fix Codespaces `actions:write` Errors When Running `gh aw run`](side-quest-08-01-codespaces-actions-write.md) — troubleshooting guide for Codespaces workflow-trigger permission errors with a UI fallback and advanced recovery path; branches from [Step 8](08-run-your-workflow.md).
