...
- [Side Quest: Frontmatter Deep Dive — Part C: Token and Usage Metadata](side-quest-11-08b-frontmatter-usage-metadata.md) — deep dive into how the model reports `input_tokens`, `output_tokens`, `stop_reason`, and `model_metadata` after each run; continues from Part B.
