...
- [Side Quest: Output Injection via Safe Outputs](side-quest-17-06-output-injection.md) — explains how attacker-controlled repository content can embed misleading markdown into trusted-looking agent output, and how `safe-outputs` constraints and minimal `permissions:` limit the blast radius; branches from [Step 17](17-add-mcp-tools.md).
