...
- [Side Quest: Using the `/agentic-workflows` Skill in Copilot](side-quest-08-02-agentic-workflows-skill.md) — how to invoke the Copilot skill installed by `gh aw init` to create, design, debug, update, and upgrade agentic workflows without leaving the chat; branches from [Step 8](08-run-your-workflow.md).
