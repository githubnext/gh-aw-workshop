...
- [GitHub Actions Basics — Triggers, Jobs, Runners, and Steps](side-quest-04-01-actions-basics.md) — line-by-line walkthrough of the core GitHub Actions primitives (trigger, job, runner, step), including what a runner is and how self-hosted runners differ; branches from [Step 4](04-github-actions-intro.md).
