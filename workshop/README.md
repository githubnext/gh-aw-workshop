...
- [How the `agentic-workflows` Skill Dispatcher Works](side-quest-09-02-skill-dispatcher.md) — explains what the `agentic-workflows` Copilot skill is, how it recognizes edit, debug, and optimize requests, and the manual fallback when no Copilot session is available; branches from [Step 9](09-agentic-editing.md).
