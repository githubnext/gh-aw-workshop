...
- **Adventure A — Add an existing workflow:** run `gh aw add githubnext/agentics/ci-doctor` (replace `ci-doctor` with your chosen workflow ID) to pull an existing workflow into your repo.
