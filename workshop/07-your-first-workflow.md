...
- **Adventure A — Add an existing workflow:** run `gh aw add githubnext/agentics/<workflow-name>` (for example, `gh aw add githubnext/agentics/ci-doctor`) to pull an existing workflow into your repo.
