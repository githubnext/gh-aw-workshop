...
You can use the `network.allow` frontmatter field to explicitly declare the domains your
workflow needs:
...
- [ ] You know how to use `network.allow` in frontmatter to declare required domains
