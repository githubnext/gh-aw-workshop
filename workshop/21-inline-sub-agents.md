...
>
> [!TIP]
> Want the full rules in smaller practice chunks? See [Side Quest: Sub-Agent Names and Block Boundaries](side-quest-21-01a-sub-agent-name-and-block-rules.md) and [Side Quest: Sub-Agent Frontmatter Fields and Chaining](side-quest-21-01b-sub-agent-frontmatter-fields.md). Stay on this page if you only want the main path.
