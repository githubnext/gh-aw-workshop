...
> [!TIP]
> Familiar with LLM-based automation tools? Review the frontmatter format summary below, then skip to [Step 7: Write Your First Agentic Workflow](07-your-first-workflow.md).
