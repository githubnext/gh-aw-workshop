...
✏️ **Try it:** Before adding this step, run `gh issue list --state open --json number --jq 'length'` in your terminal and note the count. After the workflow runs, check whether `open_issues_count` in the output matches.
