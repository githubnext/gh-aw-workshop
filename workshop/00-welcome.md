...
| Classic Actions job | Agentic workflow definition |
|---|---|
| ```yaml<br>on:<br>  schedule:<br>    - cron: \"0 8 * * *\"<br>jobs:<br>  report:<br>``` | ```markdown<br>---<br>on:<br>  schedule: \"0 8 * * *\"<br>---<br>Summarize repo activity and post an issue comment.<br>``` |
