...
If you're using the GitHub Copilot web app (`copilot-app`), you'll open a Codespace terminal in [Step 6](06-install-gh-aw.md) to install `gh-aw` — no extra setup needed now.
