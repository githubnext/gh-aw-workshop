...
3. Paste this workflow template. In the template below, keep the heading
   `# PR Code Review: Duplicate Code Detection`. Then replace the exact placeholder
   line `[Paste the full Step 10c starter brief here, replacing this line.]` with your
   final starter brief from [Step 10c: Design — PR Code Reviewer](10c-design-pr-reviewer.md#a-ready-to-use-starter-brief):
