...
- :arrow_right: [Govern Agentic Workflows Across Your Organisation](30-enterprise-governance.md) — apply org-level permissions, approval gates, and dispatch allowlists to keep automated writes safe at scale (enterprise teams).
