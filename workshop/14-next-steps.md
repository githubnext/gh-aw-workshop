...
- ➡️ [Enterprise Governance for Agentic Workflows](25-enterprise-governance.md) — control which repositories can call AI models, review audit logs, and set spending limits (enterprise teams).
