...
- ➡️ [Govern Your Agentic Workflows](27-govern-your-workflows.md) — scope permissions, restrict safe-output types, and enforce branch-protection policies so AI-authored changes are always reviewed (enterprise teams).
