...
- :arrow_right: [Govern Agentic Workflows Across Your Organisation](29-governance.md) — apply branch policies, Copilot model controls, rate limits, and CODEOWNERS to manage agentic workflows at org scale (enterprise teams).
