...
- ➡️ [Govern Agentic Workflows Across Your Organisation](25-enterprise-governance.md) — set org-level permission policies, review runs in the audit log, and protect workflow definitions with branch rules (enterprise teams).
