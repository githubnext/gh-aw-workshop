...
> - Want to understand how attacker-controlled repository content can end up embedded in trusted-looking agent output — and how `safe-outputs` constrains exactly where that output lands? Work through [Side Quest: Output Injection via Safe Outputs](side-quest-17-06-output-injection.md).  
> Then come back here.
