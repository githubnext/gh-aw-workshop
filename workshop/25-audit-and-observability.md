...
Once you have an audit report, bring it to Copilot CLI with the **`/agentic-workflows` skill** and describe what puzzled you:
...
- [ ] You brought an audit report to Copilot CLI with the `/agentic-workflows` skill and got actionable feedback
