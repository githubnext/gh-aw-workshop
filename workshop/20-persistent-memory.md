...
- You understand how `safe-outputs` controls write access (see [Side Quest: Frontmatter Deep Dive](side-quest-11-01-frontmatter-deep-dive.md) if you need a refresher).
