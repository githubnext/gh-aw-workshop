...
- If the callout has a bold title on the first line (e.g. `<b>Enterprise users only:</b>`), use that title as the `<summary>` and place the remainder of the content in the body.
