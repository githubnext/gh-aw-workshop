...
<img src="images/00-daily-repo-status-output.svg" alt="Sample daily repository status report generated by the finished workflow" width="600" />
...
<img src="images/00-workflow-run-complete.svg" alt="Preview of a completed workflow run in the GitHub Actions UI" width="600" />
...
Follow the link below for all workshop instructions and to get started on setting up your GitHub Codespace:

https://githubnext.github.io/gh-aw-workshop/#02a-setup-codespace
