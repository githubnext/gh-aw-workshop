...
_Build your first AI-powered GitHub workflow._
...
- **Format**: A self-paced, step-by-step workshop.

## How to start

Open the workshop folder and follow the steps in order, starting at Step 0:

➡️ **[workshop/00-welcome.md](workshop/00-welcome.md)**

Each step is focused. Checkboxes at the end of each step tell you exactly what to verify before moving on.

## Workshop curriculum

See the complete curriculum in **[workshop/README.md](workshop/README.md)**.
